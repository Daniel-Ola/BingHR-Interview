                        ...
                        <div class="" id="permissions-table-body">
                            <div class="d-flex justify-content-around align-items-center p-3" style="border-bottom: 1px solid rgba(0, 0, 0, 0.125);">
                                ...
                                <div class="created-tab d-flex justify-content-center">
                                    <input class="form-check-input" type="checkbox" name="super_rights" checked>
                                </div>
                            ...
                            <div class="d-flex justify-content-around align-items-center p-3" style="border-bottom: 1px solid rgba(0, 0, 0, 0.125);">
                                ...
                                <div class="created-tab d-flex justify-content-center">
                                    <input class="form-check-input" type="checkbox" name="admin_rights" checked>
                                </div>
                                <div class="role-tab d-flex justify-content-center">
                                    <input class="form-check-input" type="checkbox" name="admin_rights">
                                </div>
                                <div class="action-tab d-flex justify-content-center">
                                    <input class="form-check-input" type="checkbox" name="admin_rights">
                                </div>
                            ...
                            <div class="d-flex justify-content-around align-items-center p-3" style="border-bottom: 1px solid rgba(0, 0, 0, 0.125);">
                                ...
                                <div class="created-tab d-flex justify-content-center">
                                    <input class="form-check-input" type="checkbox" name="employee_rights" checked>
                                </div>
                                <div class="role-tab d-flex justify-content-center">
                                    <input class="form-check-input" type="checkbox" name="employee_rights">
                                </div>
                                <div class="action-tab d-flex justify-content-center">
                                    <input class="form-check-input" type="checkbox" name="employee_rights">
                                </div>
                            ...
                            <div class="d-flex justify-content-around align-items-center p-3" style="border-bottom: 1px solid rgba(0, 0, 0, 0.125);">
                                ...
                                <div class="created-tab d-flex justify-content-center">
                                    <input class="form-check-input" type="checkbox" name="hr_rights" checked>
                                </div>
                                <div class="role-tab d-flex justify-content-center">
                                    <input class="form-check-input" type="checkbox" name="hr_rights" checked>
                                </div>
