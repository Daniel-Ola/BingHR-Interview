<div id="tiny-sidebar">
    ...
    <div class="d-flex align-items-center flex-column" style="height: 100%; color: #7BC6FF;">
        ...
        <div class="d-flex flex-column justify-content-center align-items-center slim-bar">
            <i class="fa fa-gear p-2 slim-bar-item"></i>

            <div class="user-image-icon slim-bar-item" style="height: 40px; width: 40px; border-radius: 100%;">
                <img src="https://randomuser.me/api/portraits/men/73.jpg" alt="" class="w-100 h-100 position-relative rounded-circle">
            </div>

            <i class="fa fa-bars p-2 slim-bar-item"></i>
        </div>
    </div>
